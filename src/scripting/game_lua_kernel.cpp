 ...
 * content: The content of the event. This is a WML table passed verbatim into the event when it fires. If no function is specified, it will be interpreted as ActionWML, unless it has an "action" attribute, in which case that code will be compiled as the function.
